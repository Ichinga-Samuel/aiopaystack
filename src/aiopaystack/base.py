...
class Base:
    ...
    async def post(self, *, url, **kwargs) -> Response:
        if self.session:
            return self.request(method='post', url=url, headers={"Content-type": "application/json"}, **kwargs)
    ...
    async def put(self, *, url, **kwargs):
        if self.session:
            return self.request(method='put', url=url, headers={"Content-type": "application/json"}, **kwargs)
